...
if [ ! -f /var/lib/postgresql/15/main/PG_VERSION ]; then
  chown postgres /var/lib/postgresql/15/main
...
cp /etc/postgresql/15/main/conf.d/postgres-import.conf.disabled /etc/postgresql/15/main/conf.d/postgres-import.conf
